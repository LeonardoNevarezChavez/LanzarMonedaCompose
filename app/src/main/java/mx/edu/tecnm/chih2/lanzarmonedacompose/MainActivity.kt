...
import java.util.Locale as Locate
    ...
    fun MonedaButtonAndImage(modifier: Modifier = Modifier) {
        ...
        Column(
            ...
            Button(onClick = {
                ...
                aguilas_porciento = String.format(Locate.getDefault(), "%.2f", aguilas_porciento).toDouble()
                sellos_porciento = String.format(Locate.getDefault(), "%.2f", sellos_porciento).toDouble()
            })
            {
                Text(
